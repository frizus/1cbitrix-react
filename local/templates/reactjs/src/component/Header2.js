			...
			<div className="container">
				<div className="row">
					...
					<div className="col-lg-6 col-12 order-lg-2 order-3 text-lg-left text-right">
						<form action="/search/" method="GET" className="search-wrapper">
							<div className="input-group input-group-lg search">
								<input type="text" name="q" className="form-control" placeholder="Товары..."/>
								<div className="input-group-append">
									<button className="btn btn-primary has-ripple rounded-right order-2">
										<svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-search mb-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
											<path fillRule="evenodd" d="M10.442 10.442a1 1 0 0 1 1.415 0l3.85 3.85a1 1 0 0 1-1.414 1.415l-3.85-3.85a1 1 0 0 1 0-1.415z"/>
											<path fillRule="evenodd" d="M6.5 12a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11zM13 6.5a6.5 6.5 0 1 1-13 0 6.5 6.5 0 0 1 13 0z"/>
										</svg>
									</button>
									<button className="btn btn-light border rounded-0 dropdown-toggle order-1" data-toggle="dropdown">Все категории</button>
					...
					<div className="col-lg-4 col-9 order-lg-3 order-2 text-right">
						<div className="media-wrapper">
							<div className="media d-inline-flex">
								...
								<div className="media-body">
									<Link to="/favorites/" className="font-weight-bold stretched-link">Избранное</Link><br/>
							...
							<div className="media d-inline-flex ml-3">
								...
								<div className="media-body">
									<Link to="/cart/" className="font-weight-bold stretched-link">Корзина</Link><br/>
